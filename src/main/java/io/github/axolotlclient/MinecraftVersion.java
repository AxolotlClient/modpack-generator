...
public class MinecraftVersion {
    ...
    private MinecraftVersion(String version, String... modSlugs) {
    ...
    public static MinecraftVersion of(String version, boolean thisIsUnUsed, String loader, String... mods){
        return new MinecraftVersion(version, loader, mods);
    }

    public static MinecraftVersion of(String version, String... mods){
        return new MinecraftVersion(version, mods);
    }
    ...
    public static MinecraftVersion MC1193 = MinecraftVersion.of("1.19.3",
            ...
            "no-telemetry");
    public static MinecraftVersion MC1192 = MinecraftVersion.of("1.19.2",
            "qsl", "sodium", "lithium", "starlight",
            "lambdabettergrass", "lambdynamiclights", "axolotlclient", "modmenu",
            "lazydfu", "iris", "ferrite-core", "indium", "polymer", "dynamic-fps", "sodium-extra", "reeses-sodium-options",
            "no-telemetry");
    public static MinecraftVersion MC1165 = MinecraftVersion.of("1.16.5", true, "fabric",
    ...
    public static MinecraftVersion MC189 = MinecraftVersion.of("1.8.9", false, "fabric",
